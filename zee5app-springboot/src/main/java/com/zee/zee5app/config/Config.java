...
// this impl obj is created by spring
	...
	/*
	 * if we do not specify bean name then by default method name is taken as bean
	 * name ex: @Bean(name="ds") here we have to use "ds" else use "dataSource"
	 * 
	 * @Bean // for providing singleton object
	 * 
	 * @Scope("prototype") public DataSource dataSource() { BasicDataSource
	 * basicDataSource = new BasicDataSource();
	 * basicDataSource.setUsername(environment.getProperty("jdbc.username"));
	 * basicDataSource.setPassword(environment.getProperty("jdbc.password"));
	 * basicDataSource.setUrl(environment.getProperty("jdbc.url"));
	 * basicDataSource.setDefaultAutoCommit(false); return basicDataSource; }
	 */
